...
HelperAdvanced.version = "1.9.0.6 - 09.02.2020"
...
local function HelperAdvancedForageWagonEndWorkAreaProcessing(self, dt, hasProcessed)
	...
	if self.isServer then
		...
		if isHired and cH ~= nil then
			...
			-- local subScale = (1 - (cH.experienceMower * 0.45)) + 0.33
...
local function HelperAdvancedSprayerGeworkedWithSprayerUsage(self, superfunc, fillType, dt)
...
Sprayer.geworkedWithSprayerUsage = Utils.overwrittenFunction(Sprayer.geworkedWithSprayerUsage, HelperAdvancedSprayerGeworkedWithSprayerUsage)
...
local function HelperAdvancedSowingMachineEndWorkAreaProcessing(self, dt, hasProcessed)
	if self.isServer then
		...
		if isHired and cH ~= nil then
			...
			local addScale = (0.6*(1-cH.experienceSowingMachine))-0.1
