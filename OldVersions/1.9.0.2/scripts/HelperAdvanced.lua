...
HelperAdvanced.version = "1.9.0.2 - 17.01.2020"
...
function HelperAdvanced:loadMap(fileName)
	...
	for i=1, g_helperManager.numHelpers do
		...
		g_helperManager.indexToHelper[i].bexperience = g_helperManager.indexToHelper[i].experience
		...
		g_helperManager.indexToHelper[i].bBaler = g_helperManager.indexToHelper[i].eBaler
		...
		g_helperManager.indexToHelper[i].bCombine = g_helperManager.indexToHelper[i].eCombine
		...
		g_helperManager.indexToHelper[i].bCultivator = g_helperManager.indexToHelper[i].eCultivator
		...
		g_helperManager.indexToHelper[i].bSprayer = g_helperManager.indexToHelper[i].eSprayer
		...
		g_helperManager.indexToHelper[i].bMower = g_helperManager.indexToHelper[i].eMower
		...
		g_helperManager.indexToHelper[i].bSowingMachine = g_helperManager.indexToHelper[i].eSowingMachine
		...
		g_helperManager.indexToHelper[i].bPlough = g_helperManager.indexToHelper[i].ePlough
		...
		g_helperManager.indexToHelper[i].bOther = g_helperManager.indexToHelper[i].eOther
		...
		if fileExists(filename) then
			...
			if xmlFile ~= nil then
				...
				for i=1, g_helperManager.numHelpers do
					...
					g_helperManager.indexToHelper[i].bexperience = Utils.getNoNil(getXMLFloat(xmlFile, key..g_helperManager.indexToHelper[i].nameBase.."#experienceBase"),g_helperManager.indexToHelper[i].experience)
					...
					g_helperManager.indexToHelper[i].bBaler = Utils.getNoNil(getXMLFloat(xmlFile, key..g_helperManager.indexToHelper[i].nameBase.."#balerBase"),g_helperManager.indexToHelper[i].eBaler)
					...
					g_helperManager.indexToHelper[i].bCombine = Utils.getNoNil(getXMLFloat(xmlFile, key..g_helperManager.indexToHelper[i].nameBase.."#combineBase"),g_helperManager.indexToHelper[i].eCombine)
					...
					g_helperManager.indexToHelper[i].bCultivator = Utils.getNoNil(getXMLFloat(xmlFile, key..g_helperManager.indexToHelper[i].nameBase.."#cultivatorBase"),g_helperManager.indexToHelper[i].eCultivator)
					...
					g_helperManager.indexToHelper[i].bSprayer = Utils.getNoNil(getXMLFloat(xmlFile, key..g_helperManager.indexToHelper[i].nameBase.."#sprayerBase"),g_helperManager.indexToHelper[i].eSprayer)
					...
					g_helperManager.indexToHelper[i].bMower = Utils.getNoNil(getXMLFloat(xmlFile, key..g_helperManager.indexToHelper[i].nameBase.."#mowerBase"),g_helperManager.indexToHelper[i].eMower)
					...
					g_helperManager.indexToHelper[i].bSowingMachine = Utils.getNoNil(getXMLFloat(xmlFile, key..g_helperManager.indexToHelper[i].nameBase.."#sowingBase"),g_helperManager.indexToHelper[i].eSowingMachine)
					...
					g_helperManager.indexToHelper[i].bPlough = Utils.getNoNil(getXMLFloat(xmlFile, key..g_helperManager.indexToHelper[i].nameBase.."#ploughBase"),g_helperManager.indexToHelper[i].ePlough)
					...
					g_helperManager.indexToHelper[i].bOther = Utils.getNoNil(getXMLFloat(xmlFile, key..g_helperManager.indexToHelper[i].nameBase.."#otherBase"),g_helperManager.indexToHelper[i].eOther)
	...
	if g_currentMission:getIsServer() then
		...
		if xmlFile ~= nil then
			...
			for i=1, g_helperManager.numHelpers do
				...
				setXMLFloat(xmlFile, "HelperAdvanced."..g_helperManager.indexToHelper[i].nameBase.."#experienceBase", g_helperManager.indexToHelper[i].bexperience)
				...
				setXMLFloat(xmlFile, "HelperAdvanced."..g_helperManager.indexToHelper[i].nameBase.."#balerBase", g_helperManager.indexToHelper[i].bBaler)
				...
				setXMLFloat(xmlFile, "HelperAdvanced."..g_helperManager.indexToHelper[i].nameBase.."#combineBase", g_helperManager.indexToHelper[i].bCombine)
				...
				setXMLFloat(xmlFile, "HelperAdvanced."..g_helperManager.indexToHelper[i].nameBase.."#cultivatorBase", g_helperManager.indexToHelper[i].bCultivator)
				...
				setXMLFloat(xmlFile, "HelperAdvanced."..g_helperManager.indexToHelper[i].nameBase.."#sprayerBase", g_helperManager.indexToHelper[i].bSprayer)
				...
				setXMLFloat(xmlFile, "HelperAdvanced."..g_helperManager.indexToHelper[i].nameBase.."#mowerBase", g_helperManager.indexToHelper[i].bMower)
				...
				setXMLFloat(xmlFile, "HelperAdvanced."..g_helperManager.indexToHelper[i].nameBase.."#sowingBase", g_helperManager.indexToHelper[i].bSowingMachine)
				...
				setXMLFloat(xmlFile, "HelperAdvanced."..g_helperManager.indexToHelper[i].nameBase.."#ploughBase", g_helperManager.indexToHelper[i].bPlough)
				...
				setXMLFloat(xmlFile, "HelperAdvanced."..g_helperManager.indexToHelper[i].nameBase.."#otherBase", g_helperManager.indexToHelper[i].bOther)
			...
			for i=1, table.getn(g_helperManager.indexToHelper) do
				...
				if canShow then
					...
					if curHelp.hudHover == true then
						...
						renderText(posX, self.lastEntryY-(tSize*1.4), tSize*1.1, g_i18n:getText("ui_helperExperience").." (+"..tostring(math.floor((curHelp.experience-curHelp.bexperience)*1000)/10).." %)")
						...
						renderText(posX+0.26, self.lastEntryY-(tSize*1.4), tSize*1.1, g_i18n:getText("ui_helperPlough").." (+"..tostring(math.floor((curHelp.ePlough-curHelp.bPlough)*1000)/10).." %)")
						renderText(posX+0.26, self.lastEntryY-((tSize*1.4)*2), tSize*1.1, g_i18n:getText("ui_helperCultivator").." (+"..tostring(math.floor((curHelp.eCultivator-curHelp.bCultivator)*1000)/10).." %)")
						renderText(posX+0.26, self.lastEntryY-((tSize*1.4)*3), tSize*1.1, g_i18n:getText("ui_helperSprayer").." (+"..tostring(math.floor((curHelp.eSprayer-curHelp.bSprayer)*1000)/10).." %)")
						renderText(posX+0.26, self.lastEntryY-((tSize*1.4)*4), tSize*1.1, g_i18n:getText("ui_helperSowing").." (+"..tostring(math.floor((curHelp.eSowingMachine-curHelp.bSowingMachine)*1000)/10).." %)")
						...
						renderText(posX+0.475, self.lastEntryY-(tSize*1.4), tSize*1.1, g_i18n:getText("ui_helperCombine").." (+"..tostring(math.floor((curHelp.eCombine-curHelp.bCombine)*1000)/10).." %)")
						renderText(posX+0.475, self.lastEntryY-((tSize*1.4)*2), tSize*1.1, g_i18n:getText("ui_helperBaler").." (+"..tostring(math.floor((curHelp.eBaler-curHelp.bBaler)*1000)/10).." %)")
						renderText(posX+0.475, self.lastEntryY-((tSize*1.4)*3), tSize*1.1, g_i18n:getText("ui_helperMower").." (+"..tostring(math.floor((curHelp.eMower-curHelp.bMower)*1000)/10).." %)")
						renderText(posX+0.475, self.lastEntryY-((tSize*1.4)*4), tSize*1.1, g_i18n:getText("ui_helperOther").." (+"..tostring(math.floor((curHelp.eOther-curHelp.bOther)*1000)/10).." %)")
						setTextAlignment(RenderText.ALIGN_RIGHT)
						...
						renderText(posX+0.45, self.lastEntryY-(tSize*1.4), tSize*1.1, string.format(g_i18n:getText("ui_helperValue"),curHelp.pPlough,((HelperAdvanced.basePricePerHour + (price * math.max((curHelp.ePlough-curHelp.sPlough)*HelperAdvanced.workPrices["plough"],0.02)))*HelperAdvanced.workPrices["base"])))
						renderText(posX+0.45, self.lastEntryY-((tSize*1.4)*2), tSize*1.1, string.format(g_i18n:getText("ui_helperValue"),curHelp.pCultivator,((HelperAdvanced.basePricePerHour + (price * math.max((curHelp.eCultivator-curHelp.sCultivator)*HelperAdvanced.workPrices["cultivator"],0.02)))*HelperAdvanced.workPrices["base"])))
						renderText(posX+0.45, self.lastEntryY-((tSize*1.4)*3), tSize*1.1, string.format(g_i18n:getText("ui_helperValue"),curHelp.pSprayer,((HelperAdvanced.basePricePerHour + (price * math.max((curHelp.eSprayer-curHelp.sSprayer)*HelperAdvanced.workPrices["sprayer"],0.02)))*HelperAdvanced.workPrices["base"])))
						renderText(posX+0.45, self.lastEntryY-((tSize*1.4)*4), tSize*1.1, string.format(g_i18n:getText("ui_helperValue"),curHelp.pSowingMachine,((HelperAdvanced.basePricePerHour + (price * math.max((curHelp.eSowingMachine-curHelp.sSowingMachine)*HelperAdvanced.workPrices["sowing"],0.02)))*HelperAdvanced.workPrices["base"])))
						...
						renderText(posX+0.735, self.lastEntryY-(tSize*1.4), tSize*1.1, string.format(g_i18n:getText("ui_helperValue"),curHelp.pCombine,((HelperAdvanced.basePricePerHour + (price * math.max((curHelp.eCombine-curHelp.sCombine)*HelperAdvanced.workPrices["combine"],0.02)))*HelperAdvanced.workPrices["base"])))
						renderText(posX+0.735, self.lastEntryY-((tSize*1.4)*2), tSize*1.1, string.format(g_i18n:getText("ui_helperValue"),curHelp.pBaler,((HelperAdvanced.basePricePerHour + (price * math.max((curHelp.eBaler-curHelp.sBaler)*HelperAdvanced.workPrices["baler"],0.02)))*HelperAdvanced.workPrices["base"])))
						renderText(posX+0.735, self.lastEntryY-((tSize*1.4)*3), tSize*1.1, string.format(g_i18n:getText("ui_helperValue"),curHelp.pMower,((HelperAdvanced.basePricePerHour + (price * math.max((curHelp.eMower-curHelp.sMower)*HelperAdvanced.workPrices["mower"],0.02)))*HelperAdvanced.workPrices["base"])))
						renderText(posX+0.735, self.lastEntryY-((tSize*1.4)*4), tSize*1.1, string.format(g_i18n:getText("ui_helperValue"),curHelp.pOther,((HelperAdvanced.basePricePerHour + (price * math.max((curHelp.eOther-curHelp.sOther)*HelperAdvanced.workPrices["other"],0.02)))*HelperAdvanced.workPrices["base"])))
						setTextAlignment(RenderText.ALIGN_LEFT)
					end
				else
					curHelp.hudYPos = -1
	...
	if vehicle == nil then
		...
		if #g_helperManager.availableHelpers > 0 then
			for i=1, #g_helperManager.availableHelpers do
				...
				if newHelper.ownerFarmId == Utils.getNoNil(startedFarmId,g_currentMission.player.farmId) then
		...
		if newSelectedHelperId == nil or newSelectedHelperId < 1 then
			...
			if newSelectedHelperId == nil or newSelectedHelperId < 1 then
				...
				HelperAdvanced:hireHelper(newSelectedHelperId,true,g_helperManager.indexToHelper[newSelectedHelperId].isLearning,g_helperManager.indexToHelper[newSelectedHelperId].isLearnSpec,Utils.getNoNil(startedFarmId,g_currentMission.player.farmId),noEventSend)
